"""
exp013_starter_repro: CV評価スクリプト
eda017と同一条件でCV=32.04を再現確認する。
...
MODEL_PATH = str(RESULTS_DIR / "last_model")  # starterは最終epochモデルを使用
...
# ============================================================
# Inference (beam4, starter-inferと同一)
# ============================================================
...
val_preds_path = str(RESULTS_DIR / "val_predictions.csv")
...
# ============================================================
logger.info("=" * 60)
logger.info("=== Sent-level CV evaluation (beam4, eda017と同一条件) ===")
...
logger.info("")
logger.info("=== Reference: eda017 starter CV = 32.04 ===")
