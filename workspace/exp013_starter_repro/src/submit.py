"""
exp013_starter_repro: Starter推論の完全再現
...
# ============================================================
# --- ローカル用 ---
MODEL_PATH = "workspace/exp013_starter_repro/results/best_model"
TEST_PATH = "datasets/raw/test.csv"
OUTPUT_PATH = "workspace/exp013_starter_repro/results/submission.csv"

# --- Kaggle用 ---
# MODEL_PATH = "/kaggle/input/akkadianmodels/pytorch/exp013_starter_repro/1"
...
with torch.no_grad():
    for batch in tqdm(test_loader, desc="Inference"):
        ...
        outputs = model.generate(
            ...
            max_length=MAX_LENGTH,  # starterと同一
            num_beams=NUM_BEAMS,  # starterと同一: beam4
            early_stopping=True,  # starterと同一
        )
...
# starterと同一: 空文字を"broken text"に置換
