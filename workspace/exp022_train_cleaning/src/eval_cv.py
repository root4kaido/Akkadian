"""
exp022_train_cleaning: CV評価スクリプト
- exp016のeval_cv.pyベース + Host推奨前処理を適用
...
logger.info("")
logger.info("=== Reference: exp016 CV = 36.89 (ByT5-base) ===")
