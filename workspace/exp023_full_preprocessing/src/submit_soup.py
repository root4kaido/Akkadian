"""
exp023_full_preprocessing: Model Soup版 Kaggle提出用推論
- soup_model（fold0-4平均）を使用
...
if ON_KAGGLE:
    ...
    MODEL_PATH = f"{MODEL_BASE}/soup_model"
    ...
    MODEL_PATH = os.path.join(EXP_DIR, "results", "soup_model")
    TEST_PATH = os.path.join(PROJECT_ROOT, "datasets", "raw", "test.csv")
    OUTPUT_PATH = os.path.join(EXP_DIR, "results", "submission_soup.csv")
