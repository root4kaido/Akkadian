"""
exp032: Self-Training — 擬似ラベル生成
- exp023 fold3 last_modelでpublished_textsを英訳
- train.csvとの重複を除外
- repeat_cleanup + clean_translation で後処理
"""
import os
import re
import sys
...
MODEL_PATH = str(EXP023_DIR / "results" / "fold3" / "last_model")
...
# ============================================================
# Generate with fold3 last_model
# ============================================================
