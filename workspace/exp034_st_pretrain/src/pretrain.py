"""
exp034_st_pretrain: Stage1 — pseudo dataでpre-training
- pseudo_labels.csvを双方向学習データとして5epoch学習
- real dataのfold3 valでevalしてモニタリング
- 保存先: results/fold{N}/pretrain_model/
"""
import os
import gc
import re
...
args = Seq2SeqTrainingArguments(
    ...
    logging_steps=10,
    report_to="wandb",
    run_name=f"exp034_pretrain_fold{FOLD}",
...
logger.info(f"Starting Stage1 Pretrain (exp034 fold{FOLD}, {EPOCHS} epochs on pseudo data)...")
if resume_ckpt:
