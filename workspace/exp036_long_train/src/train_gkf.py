"""
exp036_long_train: exp023ベース、epoch数を100に変更
- AKTグループでGroupKFold(n_splits=5)
- --fold で実行するfoldを指定
- EPOCHS=100 以外はexp023 train_gkf.pyと同一
"""
import os
import gc
import re
...
args = Seq2SeqTrainingArguments(
    ...
    logging_steps=10,
    report_to="wandb",
    run_name=f"exp036_long_train_fold{FOLD}",
...
logger.info(f"Starting Training (exp023 GKF fold{FOLD})...")
if resume_ckpt:
