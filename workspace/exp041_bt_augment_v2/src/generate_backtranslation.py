"""
exp041: Back-Translation — generate_v2 (2 CSVs結合) を s1_exp007(byt5-large) でアッカド語に逆翻訳
- 方向: English → Akkadian
- モデル: s1_exp007_large_lr1e4/results/fold3/last_model (byt5-large)
- 入力: datasets/processed/generate_v2/generated_english.csv + generated_english_2.csv
...
INPUT_DIR = PROJECT_ROOT / "datasets" / "processed" / "generate_v2"
INPUT_CSVS = [
