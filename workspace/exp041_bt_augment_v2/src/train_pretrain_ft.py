"""
exp041_bt_augment_v2: 2段階学習 (exp034方式)
Stage 1: BT(23k) + pseudo_labels_v2(6k) で pretrain 5ep
Stage 2: real train で finetune 5ep
- byt5-base, bidirectional training
...
BT_DATA_PATH = EXP_DIR / "dataset" / "backtranslated.csv"
...
logger.info(f"Back-translated data: {len(bt_df)} samples")
...
if should_pretrain:
    ...
    pretrain_args = Seq2SeqTrainingArguments(
        ...
        logging_steps=10,
        report_to="wandb",
        run_name=f"exp041_pretrain_ft_stage1_fold{FOLD}",
...
if should_finetune:
    ...
    finetune_args = Seq2SeqTrainingArguments(
        ...
        logging_steps=10,
        report_to="wandb",
        run_name=f"exp041_pretrain_ft_stage2_fold{FOLD}",
