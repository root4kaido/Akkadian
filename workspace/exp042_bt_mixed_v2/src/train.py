"""
exp042_bt_mixed_v2: BT(23k) + real train 混合学習 10ep
- exp038と同手法だがgenerate_v2(23k件)に拡大
- byt5-base, 10 epochs, bidirectional training
...
args = Seq2SeqTrainingArguments(
    ...
    logging_steps=10,
    report_to="wandb",
    run_name=f"exp042_bt_mixed_v2_fold{FOLD}",
...
logger.info(f"Starting Training (exp042 BT mixed v2 fold{FOLD})...")
if resume_ckpt:
