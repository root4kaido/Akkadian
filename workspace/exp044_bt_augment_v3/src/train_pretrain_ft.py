"""
exp044_bt_augment_v3: 2段階学習 (exp041方式)
Stage 1: BT(62k) + pseudo_labels_v2(6k) で pretrain 5ep
...
if should_pretrain:
    ...
    pretrain_args = Seq2SeqTrainingArguments(
        ...
        logging_steps=10,
        report_to="wandb",
        run_name=f"exp044_pretrain_ft_stage1_fold{FOLD}",
...
if should_finetune:
    ...
    finetune_args = Seq2SeqTrainingArguments(
        ...
        logging_steps=10,
        report_to="wandb",
        run_name=f"exp044_pretrain_ft_stage2_fold{FOLD}",
