"""
s1_exp001_byt5_large_fold3: Kaggle提出用推論
- exp023_full_preprocessing/submit.pyベース
- モデル: byt5-large fold3/last_model
...
if ON_KAGGLE:
    MODEL_BASE = "/kaggle/input/akkadianmodels/pytorch/s1_exp001_byt5_large_fold3/1"
