"""
s1_exp005_large_freeze: byt5-large, epoch=5, lr=5e-5
...
# Freeze decoder bottom 12 layers (out of 24), keep top 12 trainable
FREEZE_DECODER_LAYERS = 12
...
args = Seq2SeqTrainingArguments(
    ...
    logging_steps=10,
    report_to="wandb",
    run_name=f"s1_exp005_large_freeze_fold{FOLD}",
