"""
s1_exp001_byt5_large_fold3: exp023ベース、byt5-large版
- AKTグループでGroupKFold(n_splits=5)
- --fold で実行するfoldを指定
- モデルをgoogle/byt5-largeに変更、その他はexp023と同一
"""
import os
import gc
import re
...
args = Seq2SeqTrainingArguments(
    ...
    logging_steps=10,
    report_to="wandb",
    run_name=f"s1_exp007_large_lr1e4_fold{FOLD}",
...
logger.info(f"Starting Training (s1_exp001 byt5-large GKF fold{FOLD})...")
if resume_ckpt:
