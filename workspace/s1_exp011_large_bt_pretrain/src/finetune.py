"""
s1_exp011_large_bt_pretrain: Stage2 — pretrain済みモデルでreal dataをfine-tune
- Stage1のpretrain_model (byt5-large) をロード
- real dataで5epoch fine-tune (lr=2e-5)
...
args = Seq2SeqTrainingArguments(
    ...
    logging_steps=10,
    report_to="wandb",
    run_name=f"s1_exp011_finetune_fold{FOLD}",
...
logger.info(f"Starting Stage2 Fine-tune (s1_exp011 fold{FOLD}, {EPOCHS} epochs on real data)...")
if resume_ckpt:
